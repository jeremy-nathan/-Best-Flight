...
#
# origin2 = 'Shanghai'
# Shanghai_location =geolocator.geocode(origin2,timeout = 100)
...
for i in range(len(cities)):
 for j in range(len(cities)):
    print("Distance between "+cities[i]+" and "+cities[j])
    cities_distance[i]=int(distance.distance((cities_latitude[i],cities_longitude[i]),(cities_latitude[j],cities_longitude[j])).kilometers)
...
#
# origin3 = 'New York'
# NewYork_location =geolocator.geocode(origin3,timeout = 100)
...
#for i in range(len(cities_latitude)):
